# Establishing programmer dictionary
...
epic_programmer_dict = {
    ...
    'mikael stadden':['mksteezy@gmail.com',666]
    }
...
#Main function: Loop to initiate search and ask again
...
def mainSearch():
    ...
    while userWantsMore == True:
        ...
        if searchAgain == 'y':
            ...
            print 'I do not understand what you mean - system quitting'
            userWantsMore = False
